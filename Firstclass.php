...
<html>
    <head>
     <title>GRACE FIRST CLASS</title>
       <?php include "header.php" ;?>
   <?php include "api.php";?>
     <link href="css/Firstclass.css" rel="stylesheet">
    </head>
...
<div class= "input-n">
  <div class="n">
    <label for="Pick date and date:">Departure:</label>
    <input type="datetime-local" id="Pick date and date:"> 
  </div>
    <div class="n">
    <label for="Pick date and date:">Arrival:</label>
    <input type="datetime-local" id="Pick date and date:"> 
  </div>
  <div class="n">
